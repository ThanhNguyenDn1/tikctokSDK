 ...
 */
public class RitConstants {
    public static final String AD_APP_ID = "8025677";

    // Interstitial Ad
    public static final String RIT_INTER_VERTICAL = "980088188";
    public static final String RIT_INTER_HORIZONTAL= "980099798";
    ...
    public static final String RIT_BANNER_320X50 = "980099802";
